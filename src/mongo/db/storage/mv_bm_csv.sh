...
if ! test -f /tmp/people-2000000.csv; then
    ...
    echo 'Index/int32,Organization Id/string,Name/string,Website/string,Country/string,Description/string,Founded/string,Industry/string,Number of employees/int32' > /tmp/people.txt
fi
